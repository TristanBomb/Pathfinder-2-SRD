...
Each time you gain a new level, you can add formulas for two alchemical items to your formula book.  These can be of any level of item you can create.  You learn these formulas automatically, but it's also possible for you to find or buy other formulas, or to invent them with the Inventor feat (see page 167).

<blockquote class="note" markdown="1">
**Note:** Alchemists start with 8 formulas in their formula book; 4 from the Alchemical Crafting feat, and 4 with their Formula Book.
</blockquote>
...
### Alchemist Feats
At 1st level and every even numbered level thereafter, you gain an Alchemist class feat.  Alchemist class feats are described on page 48.
...
### Empower Bombs (3rd)
When you craft an alchemical item with the bomb and infused traits - hereafter referred to in this entry as a bomb - you can empower it.  You can only empower a 1st level bomb, increasing its level and causing it to do more damage. This also increases any persistent damage dealt by the bomb, but not it's splash damage.
*  At 3rd level, you can create 3rd-level bombs that deal double the bomb's base damage as presented in its entry. For instance, if you created a 3rd-level empowered alchemist's fire (see page 360), it would deal 2d6 fire damage, 2 persistent fire damage, and 1 splash damage on a hit.
*  At 7th level, you can create 7th-level bombs that deal three times the base damage.
*  At 11th level, you can create 11th-level bombs that deal four times the base damage. 
*  At 15th level, you can create 15th-level bombs that deal 5 times the base damage, and attack rolls with your empowered bombs gain a +1 item bonus.
*  At 19th level,  you can create 19th-level bombs that deal 6 times the base damage, and attack rolls with your empowered bombs gain a +2 item bonus.

### General Feats (3rd)
At 3rd level and every 4 levels thereafter, you gain a general feat.  General feats are listed in Chapter 5.

### Skill Increases (3rd)
At 3rd level and every 2 levels thereafter, you gain a skill increase.  You can use this increase to either become trained in one skill you're untrained in or become an expert in a skill in which you are already trained. 

If you're at least 7th level, you can use this increase to become a master in a signature skill in which you are already an expert.  If you are at least 15th level, you can use this increase to become legendary in a signature skill in which you are already a master.

### Mutagen Crafting (5th)
You learn the secrets of mutagens.  When you gain a new level and add new formulas to your formula book, you can select formulas for uncommon alchemical items with the mutagen trait.

### Ability Boosts (5th)
At 5th level and every 5 levels thereafter, you boost four different ability scores.  You can use these boosts to increase your ability scores above 18.  Boosting an ability score increases it by 1 if it's already 18 or above, or by 2 if it starts out below 18.
...
### Double Elixer (13th)
When using the Quick Alchemy action, instead of using 1 Resonance Point to create a single item, you can spend up to 2 Resonance Points to make up to 2 alchemical items as described in that action.  Those items need not be the same.
